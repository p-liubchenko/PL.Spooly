...
- Create Angular project with ng: `ng new pricer.webapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`pricer.webapp.client.esproj`).
